...
def main():
    ...
    print("=" * 70)
    print("    (Edges are split including those involving boundary vertices)")
    ...
    print(f"  Subremeshing (partition-based):  {len(result3_v):4d} vertices, {len(result3_f):4d} faces")
    print(f"  Histogram (partition-based):     {len(result4_v):4d} vertices, {len(result4_f):4d} faces")
    print()
    print("Key differences:")
    print("  - Without partitioning: Processes entire mesh at once")
    print("  - With partitioning:    Processes mesh in 8 spatial partitions independently")
    print()
